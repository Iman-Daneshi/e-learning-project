...
from .views import ManageCourseListView, CourseCreateView, CourseDeleteView, CourseUpdateView, CourseModuleUpdateView, ContentCreateUpdateView, ContentDeleteView, ModuleContentListView, ModuleOrderView, ContentOrderView
